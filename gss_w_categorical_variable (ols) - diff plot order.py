...
df['sex']=1
gun_vote_pred_men = results_logirg.predict(df) #saves the results from one variable value
df['sex']=2
gun_vote_pred_women = results_logirg.predict(df) #saves the results as another variable value

plt.plot(df['age'], gun_vote_pred_men, label="men") #plots the predicted male values stored from above
plt.plot(df['age'], gun_vote_pred_women, label="women") #plots the predicted female values stored from above
